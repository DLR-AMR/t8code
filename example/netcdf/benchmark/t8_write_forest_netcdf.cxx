...
/** Function that stores the given (uniform) 
 in a netCDF-4 File using the different netCDF variable storage and mpi-access patterns (four files are going to be put out (each combination of {NC_CONTIGUOUS; NC_CHUNKED}x{NC_INDEPENDENT; NC_COLLECTIVE})). 
* \param [in] comm The MPI communicator to use.
...
main (int argc, char **argv)
{
  ...
  int                 forest_initial_refinement_level = 7;
