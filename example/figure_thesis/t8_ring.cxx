                          ...
                          t8_element_t * elements[])
{
  ...
  if (is_family == 1
      && (dist < adapt_data->radius ||
          dist > adapt_data->radius + adapt_data->with_ring ))
  {
    return -1;
  }
  return 0;
...
main (int argc, char **argv)
{
  ...
  struct t8_adapt_data adapt_data = { {0.5, 0.5, 0}, 0.3, 0.005 };
  
  t8_forest_write_vtk (forest, "/home/ioannis/VBshare/paraview_export/t8_example_0_base");

  t8_debugf ("[IL] REFINE \n");
  forest = t8_forest_new_adapt (forest, t8_adapt_callback_refine, 0, 0, &adapt_data);

  //t8_forest_write_vtk (forest, "/home/ioannis/VBshare/paraview_export/t8_example_1_refine");

  forest = t8_balance (forest);
  ...
  t8_forest_write_vtk (forest, "/home/ioannis/VBshare/paraview_export/t8_example_1_refine_balance");

  t8_debugf ("[IL] REMOVE \n");
  forest = t8_forest_new_adapt (forest, t8_adapt_callback_remove, 0, 0, &adapt_data);
  t8_forest_write_vtk (forest, "/home/ioannis/VBshare/paraview_export/t8_example_2_remove");
