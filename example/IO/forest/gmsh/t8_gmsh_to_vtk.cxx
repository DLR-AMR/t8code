...
main (int argc, char **argv)
{
  ...
  sreturn = snprintf (
    help, BUFSIZ,
    "Read in a `.msh` file generated by Gmsh and write it into a VTU file.\n");
  ...
  sc_options_add_int (opt, 'o', "use_cad", &use_cad, 0, "Enable CAD-based curvilinear geometry. Needs a `.brep` file with the same file prefix. Default: 0");
  ...
  if (helpme) {
...

    {
      ...
      t8_forest_write_vtk_ext (forest, fileprefix, write_treeid, write_mpirank, write_level, write_element_id, write_ghosts,
                               write_curved, do_not_use_api, num_data, NULL);
