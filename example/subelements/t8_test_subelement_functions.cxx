...
t8_productionf ("In this function we will construct a single element and refine it using a transition cell of a given type,\n"
                "which consists of different subelements.\n");
