...
t8_refine_quad_to_subelements () 
{
    ...
    ("In this function we will construct a single element and refine it using a transition cell of a given type,\n"
  ...
    class_scheme->t8_element_destroy (num_subelements,
                                         element_subelements);
