...
t8_refine_quad_to_subelements () 
{
  ...
  t8_productionf ("In this function we will construct a single element and refine it using subelements.\n");
  ...
  t8_element_t **element_subelements = T8_ALLOC (t8_element_t *, num_subelements);
  ...
  t8_productionf ("The transition cell of type %i consists of %i subelements with ids ranging from 0 to %i.\n", type, num_subelements, num_subelements - 1);
