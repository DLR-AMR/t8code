 ...
 */
static void
t8_step5_output_data_to_vtu (t8_forest_t forest, std::vector<t8_step5_data_per_element> data, const char *prefix)
{
...
t8_step5_main (int argc, char **argv)
{
   ...
   */
  auto data = t8_step5_create_element_data (forest);
