/*
  ...
  !! Modifed by Prasanna Ponnusamy 
  !! to create a moving refinement sphere from left to right in 10 timesteps
 ...
 * \param [in] which_tree   The process local id of the current tree.t8_step3_adapt_data
...
{0.5, 0.5, counter}, /* Midpoints of the sphere. !! added the counter for z-axis */ 
...
prefix_uniform);
     ...
     *
     * !!!
     * Alteration for 3_1 task of 10 timesteps and moving refinement sphere.
...
t8_global_productionf
      (" [step3] Wrote adapted forest to vtu files: %s*\n", 
filename);
