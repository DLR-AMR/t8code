 ...
 * \param [in]        forest      The forest containing the element with possible interesection.
 * \param [in]        tree_id     The tree id of the tree in \a forest that contains the element.
 * \param [in]        element         The  element.
