 ...
 */
void
t8_cmesh_set_partition_uniform (t8_cmesh_t cmesh, int element_level, const t8_scheme_c *scheme);
...
void
t8_cmesh_set_refine (t8_cmesh_t cmesh, int level, const t8_scheme_c *scheme);
