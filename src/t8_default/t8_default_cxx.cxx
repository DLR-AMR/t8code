...
{
  switch(ts->eclass) {
  case T8_ECLASS_VERTEX: return T8_COMMON_IS_TYPE(ts, t8_default_scheme_vertex_c*);
  case T8_ECLASS_LINE: return T8_COMMON_IS_TYPE(ts, t8_default_scheme_line_c*);
  case T8_ECLASS_QUAD: return T8_COMMON_IS_TYPE(ts, t8_default_scheme_quad_c*);
  case T8_ECLASS_TRIANGLE: return T8_COMMON_IS_TYPE(ts, t8_default_scheme_tri_c*);
