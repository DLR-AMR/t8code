...
const int           t8_dtet_type_face_to_boundary[6][4][3] = {
  {{1, 2, 1}, {1, 2, 1}, {0, 2, 0}, {0, 2, 0}},
  {{1, 2, 0}, {1, 2, 0}, {0, 2, 0}, {0, 1, 0}},
  {{0, 2, 0}, {1, 2, 0}, {1, 2, 0}, {0, 1, 1}},
  {{0, 2, 1}, {0, 2, 1}, {1, 2, 0}, {1, 2, 0}},
  {{0, 1, 1}, {0, 2, 1}, {1, 2, 1}, {1, 2, 1}},
  {{0, 1, 0}, {1, 2, 1}, {1, 2, 1}, {0, 2, 1}}
};
