...
#if 1
    succ->tri.x =
      (succ->tri.x >> (T8_DPRISM_MAXLEVEL - level + 1)) << (T8_DPRISM_MAXLEVEL -
                                                          level + 1);
    succ->tri.y =
      (succ->tri.y >> (T8_DPRISM_MAXLEVEL - level + 1)) << (T8_DPRISM_MAXLEVEL -
                                                          level + 1);
#endif
#if 1
    succ->line.x =
      (succ->line.x >> (T8_DPRISM_MAXLEVEL - level + 1)) << (T8_DPRISM_MAXLEVEL -
                                                           level + 1);
#endif
