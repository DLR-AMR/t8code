 ...
 */
   ...
   */
  int
  get_common_edge (const int vertex1_index, const int vertex2_index) const;
   ...
   */
  int
  get_common_face (const int edge1_index, const int edge2_index) const;
   ...
   */
  void
  get_parameter_of_vertex_on_edge (const int vertex_index, const int edge_index, double *edge_param) const;
   ...
   */
  void
  get_parameters_of_vertex_on_face (const int vertex_index, const int face_index, double *face_params) const;
   ...
   */
  void
  edge_parameter_to_face_parameters (const int edge_index, const int face_index, const int num_face_nodes,
                                     const double edge_param, const double *surface_params, double *face_params) const;
   ...
   */
  int
  is_edge_closed (int edge_index) const;
