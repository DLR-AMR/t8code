...
typedef struct t8_forest
{
  ...
  t8_locidx_t local_num_elements;  /**< Number of leaf elements on this processor. */
  t8_gloidx_t global_num_elements; /**< Number of leaf elements on all processors. */
...
{
  t8_element_array_t elements; /**< locally stored leaf elements */
