                                    ...
                                    const int check_ghost)
{
   ...
   * element candidate. */
  /* Get the array */
  const t8_element_array_t *elements = check_ghost ? t8_forest_ghost_get_tree_leaf_elements (forest, local_tree) : t8_forest_tree_get_leaf_elements (forest, local_tree) ;
