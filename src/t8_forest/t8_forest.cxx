...
t8_locidx_t
t8_forest_element_leaf_index_in_tree (const t8_forest_t forest, const t8_element_t *element,
                                      const t8_locidx_t local_tree)
{
  T8_ASSERT (t8_forest_is_committed (forest));
  T8_ASSERT (t8_forest_tree_is_local (forest, local_tree));
...
{
  T8_ASSERT (t8_forest_is_initialized (forest));
  /* We currently only support face ghosts or vertex ghosts on a hardcoded coarse mesh */
