...
extern const int    t8_element_shape_max_num_faces[];

/** The number of vertices of an element class. */
extern const int    t8_element_shape_num_vertices[];

/** The vtk cell type for the element_shape */
extern const int    t8_element_shape_vtk_type[];

/** For each element_shape, the name of this class as a string */
extern const char  *t8_element_shape_to_string[];
