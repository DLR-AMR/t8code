...
/** Copy one element to another */
  virtual void
  t8_element_copy (const t8_element_t *source,
...
/** Construct a same-size sibling of a given element. */
   ...
   */
  virtual int
  t8_element_get_num_sibling_neighbors_at_face (const t8_element_t *elem,
                                                int face) const;
   ...
   */
  virtual int
  t8_element_get_face_corner (const t8_element_t *element,
   ...
   */
  virtual int
  t8_element_get_corner_face (const t8_element_t *element,
   ...
   * It is valid to call this function with elem = child.
     */
  virtual void
  t8_element_child (const t8_element_t *elem,
                    int childid,
...
/** Construct all children of a given element. */
  virtual void
  t8_element_children (const t8_element_t *elem,
                       int length,
...
/** Return the child id of an element */
  ...
  virtual int
  t8_element_ancestor_id (const t8_element_t *elem,
                          int level) const;
...
/** Construct the nearest common ancestor of two elements in the same tree. */
   ...
   * the element that touch the face. */
  virtual void
  t8_element_children_at_face (const t8_element_t *elem,
                               int face,
  ...
  virtual int
  t8_element_face_child_face (const t8_element_t *elem,
                              int face, int face_child) const;
  ...
  virtual int
  t8_element_face_parent_face (const t8_element_t *elem,
                               int face) const;

  /** Transform the coordinates of a hexaliteral considered as boundary element
   *  in a tree-tree connection. */
  virtual void
  t8_element_transform_face (const t8_element_t *elem1,
                             t8_element_t *elem2,
  ...
  virtual int
  t8_element_tree_face (const t8_element_t *elem,
                        int face) const;
  ...
  virtual void
  t8_element_boundary_face (const t8_element_t *elem,
                            int face, t8_element_t *boundary,
                            const t8_eclass_scheme_c *boundary_scheme) const;

/** Construct all codimension-one boundary elements of a given element. */
  virtual void
  t8_element_boundary (const t8_element_t *elem,
   ...
   */
  virtual int
  t8_element_is_root_boundary (const t8_element_t *elem,
                               int face) const;
...
/** Initialize an element according to a given linear id */
  virtual void
  t8_element_set_linear_id (t8_element_t *elem,
                            int level, t8_linearidx_t id) const;

/** Calculate the linear id of an element */
  virtual t8_linearidx_t 
  t8_element_get_linear_id (constt8_element_t *elem,
                            int level) const;
 ...
 */
  virtual void
  t8_element_first_descendant (const t8_element_t *elem,
                               t8_element_t *desc,
                               int level) const;
 ...
 */
  virtual void
  t8_element_last_descendant (const t8_element_t *elem,
                              t8_element_t *desc,
                              int level) const;
...
/** Get the integer coordinates of the anchor node of an element */
  virtual void
  t8_element_anchor (const t8_element_t *elem,
                     int anchor[3]) const;
...
/** Compute the integer coordinates of a given element vertex. */
  virtual void
  t8_element_vertex_coords (const t8_element_t *t,
                            int vertex,
                            int coords[]) const;
 ...
 */
  virtual int
  t8_element_find_neighbor_in_transition_cell (const t8_element_t *elem,
...
/** Compute the coordinates of a given element vertex inside a reference tree
   ...
   */
  virtual void
  t8_element_vertex_reference_coords (const t8_element_t *t, int vertex,
                                      double coords[]) const;
...
protected:
   ...
   */
  void
  t8_element_vertex_coords_of_subelement (const t8_element_t *t,
                                         int vertex,
                                         int coords[]) const;
   ...
   */
  void
  t8_element_copy_subelement_values (const t8_element_t *source,
                                     t8_element_t *dest) const;
