...
#ifndef T8_CONSECUTIVE_QUAD_CXX_HXX
#define T8_CONSECUTIVE_QUAD_CXX_HXX
...
struct t8_consecutive_scheme_quad_c: public t8_consecutive_scheme_common_c
{
 public:
  /** The virtual table for a particular implementation of an element class. */

  /** Constructor. */
  t8_consecutive_scheme_quad_c ();
...
#endif /* !T8_CONSECUTIVE_QUAD_CXX_HXX */