...
void                t8_sele_init_linear_id (t8_standalone_element_t<eclass_T> *p,
                                                const int level,
                                                t8_linearidx_t id);
 ...
 */
template<t8_eclass_t eclass_T>
void                t8_sele_copy (const t8_standalone_element_t<eclass_T> *source,
 ...
 */
template<t8_eclass_t eclass_T>
t8_linearidx_t      t8_sele_linear_id (const t8_standalone_element_t<eclass_T> *p,
                                           const int level);
 ...
 */
template<t8_eclass_t eclass_T>
void                t8_sele_child (const t8_standalone_element_t<eclass_T> *elem,
                                       const int child_id,
 ...
 */
template<t8_eclass_t eclass_T>
void                t8_sele_children_at_face (const t8_standalone_element_t<eclass_T> *p,
                                                  const int face,
                                                  t8_standalone_element_t<eclass_T> *children[],
 ...
 */
template<t8_eclass_t eclass_T>
t8_element_shape_t  t8_sele_face_shape (const t8_standalone_element_t<eclass_T> *pyra,
                                            int face);
 ...
 */
template<t8_eclass_t eclass_T>
int                 t8_sele_compare (const t8_standalone_element_t<eclass_T> *p1,
                                         const t8_standalone_element_t<eclass_T> *p2);
 ...
 */
template<t8_eclass_t eclass_T>
int                 t8_sele_is_family (t8_standalone_element_t<eclass_T> **fam);
 ...
 */
template<t8_eclass_t eclass_T>
int                 t8_sele_is_root_boundary (const t8_standalone_element_t<eclass_T> *p,
                                                  const int face);
 ...
 */
template<t8_eclass_t eclass_T>
int                 t8_sele_child_id (const t8_standalone_element_t<eclass_T> *p);
 ...
 */
template<t8_eclass_t eclass_T>
int                 t8_sele_is_inside_root (const t8_standalone_element_t<eclass_T> *p);
 ...
 */
template<t8_eclass_t eclass_T>
int                 t8_sele_tet_boundary (const t8_standalone_element_t<eclass_T> *p,
                                              const int face);
 ...
 */
template<t8_eclass_t eclass_T>
int                 t8_sele_tree_face (const t8_standalone_element_t<eclass_T> *p,
                                           const int face);
 ...
 */
template<t8_eclass_t eclass_T>
void                t8_sele_first_descendant (const t8_standalone_element_t<eclass_T> *p,
                                                  t8_standalone_element_t<eclass_T> *desc,
                                                  const int level);
 ...
 */
template<t8_eclass_t eclass_T>
void                t8_sele_first_descendant_face (const t8_standalone_element_t<eclass_T> *p,
                                                       const int face,
                                                       t8_standalone_element_t<eclass_T>
                                                       *first_desc,
                                                       const int level);
 ...
 */
template<t8_eclass_t eclass_T>
void                t8_sele_last_descendant (const t8_standalone_element_t<eclass_T> *p,
                                                 t8_standalone_element_t<eclass_T> *desc,
                                                 int level);
 ...
 */
template<t8_eclass_t eclass_T>
void                t8_sele_last_descendant_face (const t8_standalone_element_t<eclass_T> *p,
                                                      const int face,
                                                      t8_standalone_element_t<eclass_T>
                                                      *last_desc,
                                                      const int level);
 ...
 */
template<t8_eclass_t eclass_T>
void                t8_sele_compute_coords (const t8_standalone_element_t<eclass_T> *p,
                                                const int vertex,
                                                int coords[]);
 ...
 */
template<t8_eclass_t eclass_T>
void                t8_sele_parent (const t8_standalone_element_t<eclass_T> *p,
 ...
 */
template<t8_eclass_t eclass_T>
int                 t8_sele_num_corners (const t8_standalone_element_t<eclass_T> *p);
 ...
 */
template<t8_eclass_t eclass_T>
int                 t8_sele_num_children (const t8_standalone_element_t<eclass_T> *p);
 ...
 */
template<t8_eclass_t eclass_T>
int                 t8_sele_num_siblings (const t8_standalone_element_t<eclass_T> *p);
 ...
 */
template<t8_eclass_t eclass_T>
int                 t8_sele_num_faces (const t8_standalone_element_t<eclass_T> *p);
 ...
 */
template<t8_eclass_t eclass_T>
int                 t8_sele_max_num_faces (const t8_standalone_element_t<eclass_T> *p);
 ...
 */
template<t8_eclass_t eclass_T>
int                 t8_sele_ancestor_id (const t8_standalone_element_t<eclass_T> *p,
                                             const int level);
 ...
 */
template<t8_eclass_t eclass_T>
t8_element_type_t t8_sele_type_at_level (const t8_standalone_element_t<eclass_T> *p,
                                               const int level);
 ...
 */
template<t8_eclass_t eclass_T>
t8_element_shape_t  t8_sele_shape (const t8_standalone_element_t<eclass_T> *p);
 ...
 */
template<t8_eclass_t eclass_T>
void                t8_sele_successor (const t8_standalone_element_t<eclass_T> *elem,
                                           t8_standalone_element_t<eclass_T> *s, const int level);
 ...
 */
template<t8_eclass_t eclass_T>
void                t8_sele_vertex_reference_coords (const t8_standalone_element_t<eclass_T>
                                                         *elem,
                                                         const int vertex,
                                                         double coords[]);
 ...
 */
template<t8_eclass_t eclass_T>
void                t8_sele_nearest_common_ancestor (const t8_standalone_element_t<eclass_T>
                                                         *el1,
                                                         const t8_standalone_element_t<eclass_T>
                                                         *el2,
 ...
 */
template<t8_eclass_t eclass_T>
int                 t8_sele_is_valid (const t8_standalone_element_t<eclass_T> *p);
 ...
 */
template<t8_eclass_t eclass_T>
void                t8_sele_debug_print (const t8_standalone_element_t<eclass_T> *p);

template<t8_eclass_t eclass_T>
void                t8_sele_global_print (const t8_standalone_element_t<eclass_T> *p);
