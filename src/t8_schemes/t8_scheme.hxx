...
class t8_scheme {
 ...
 public:
   ...
   * \param [in] scheme_id    The id of the current eclass_scheme.
   * \return                    True if the scheme is of type \a TEclassScheme, false otherwise.
   */
  template <class TEclassScheme>
  inline bool
  check_eclass_scheme_type (const t8_scheme_id scheme_id) const
  {
    return std::holds_alternative<TEclassScheme> (eclass_schemes[scheme_id]);
  }
   ...
   */
  inline t8_scheme_id
  get_eclass_scheme_eclass (const t8_scheme_id scheme_id) const
  {
    return std::visit ([&] (auto &&scheme) { return scheme.eclass; }, eclass_schemes[scheme_id.get ()]);
  }
   ...
   */
  inline size_t
  get_element_size (const t8_scheme_id scheme_id) const
  {
    return std::visit ([&] (auto &&scheme) { return scheme.get_element_size (); }, eclass_schemes[scheme_id.get ()]);
  };
   ...
   */
  inline bool
  refines_irregular (const t8_scheme_id scheme_id) const
  {
    return std::visit ([&] (auto &&scheme) { return scheme.refines_irregular (); }, eclass_schemes[scheme_id.get ()]);
  };
   ...
   */
  inline int
  get_maxlevel (const t8_scheme_id scheme_id) const
  {
    return std::visit ([&] (auto &&scheme) { return scheme.get_maxlevel (); }, eclass_schemes[scheme_id.get ()]);
  };
   ...
   */
  inline int
  element_get_level (const t8_scheme_id scheme_id, const t8_element_t *elem) const
  {
    return std::visit ([&] (auto &&scheme) { return scheme.element_get_level (elem); }, eclass_schemes[scheme_id.get ()]);
  };
   ...
   */
  inline void
  element_copy (const t8_scheme_id scheme_id, const t8_element_t *source, t8_element_t *dest) const
  {
    return std::visit ([&] (auto &&scheme) { return scheme.element_copy (source, dest); }, eclass_schemes[scheme_id.get ()]);
  };
   ...
   */
  inline int
  element_compare (const t8_scheme_id scheme_id, const t8_element_t *elem1, const t8_element_t *elem2) const
  {
    return std::visit ([&] (auto &&scheme) { return scheme.element_compare (elem1, elem2); },
                       eclass_schemes[scheme_id.get ()]);
  };
  ...
  */
  inline bool
  element_is_equal (const t8_scheme_id scheme_id, const t8_element_t *elem1, const t8_element_t *elem2) const
  {
   ...
   */
  inline void
  element_get_parent (const t8_scheme_id scheme_id, const t8_element_t *elem, t8_element_t *parent) const
  {
   ...
   */
  inline int
  element_get_num_siblings (const t8_scheme_id scheme_id, const t8_element_t *elem) const
  {
   ...
   */
  inline void
  element_get_sibling (const t8_scheme_id scheme_id, const t8_element_t *elem, const int sibid,
   ...
   */
  inline int
  element_get_num_corners (const t8_scheme_id scheme_id, const t8_element_t *elem) const
  {
   ...
   */
  inline int
  element_get_num_faces (const t8_scheme_id scheme_id, const t8_element_t *elem) const
  {
    return std::visit ([&] (auto &&scheme) { return scheme.element_get_num_faces (elem); }, eclass_schemes[scheme_id.get ()]);
  };
   ...
   */
  inline int
  element_get_max_num_faces (const t8_scheme_id scheme_id, const t8_element_t *elem) const
  {
   ...
   */
  inline int
  element_get_num_children (const t8_scheme_id scheme_id, const t8_element_t *elem) const
  {
   ...
   */
  inline int
  element_get_num_face_children (const t8_scheme_id scheme_id, const t8_element_t *elem, const int face) const
  {
   ...
   */
  inline int
  element_get_face_corner (const t8_scheme_id scheme_id, const t8_element_t *element, const int face,
   ...
   */
  inline int
  element_get_corner_face (const t8_scheme_id scheme_id, const t8_element_t *element, const int corner,
   ...
   */
  inline void
  element_get_child (const t8_scheme_id scheme_id, const t8_element_t *elem, const int childid,
   ...
   */
  inline void
  element_get_children (const t8_scheme_id scheme_id, const t8_element_t *elem, const int length,
   ...
   */
  inline int
  element_get_child_id (const t8_scheme_id scheme_id, const t8_element_t *elem) const
  {
    return std::visit ([&] (auto &&scheme) { return scheme.element_get_child_id (elem); }, eclass_schemes[scheme_id.get ()]);
  };
   ...
   */
  inline int
  element_get_ancestor_id (const t8_scheme_id scheme_id, const t8_element_t *elem, const int level) const
  {
   ...
   */
  inline bool
  elements_are_family (const t8_scheme_id scheme_id, t8_element_t *const *fam) const
  {
    return std::visit ([&] (auto &&scheme) { return scheme.elements_are_family (fam); }, eclass_schemes[scheme_id.get ()]);
  };
   ...
   */
  inline void
  element_get_nca (const t8_scheme_id scheme_id, const t8_element_t *elem1, const t8_element_t *elem2,
  ...
  element_get_face_shape (const t8_scheme_id scheme_id, const t8_element_t *elem, const int face) const
  {
   ...
   */
  inline void
  element_get_children_at_face (const t8_scheme_id scheme_id, const t8_element_t *elem, const int face,
   ...
   */
  inline int
  element_face_get_child_face (const t8_scheme_id scheme_id, const t8_element_t *elem, const int face,
   ...
   */
  inline int
  element_face_get_parent_face (const t8_scheme_id scheme_id, const t8_element_t *elem, const int face) const
  {
   ...
   */
  inline int
  element_get_tree_face (const t8_scheme_id scheme_id, const t8_element_t *elem, const int face) const
  {
   ...
   */
  inline void
  element_transform_face (const t8_scheme_id scheme_id, const t8_element_t *elem1, t8_element_t *elem2,
   ...
   */
  inline int
  element_extrude_face (const t8_scheme_id scheme_id, const t8_element_t *face, t8_element_t *elem,
   ...
   */
  inline void
  element_get_boundary_face (const t8_scheme_id scheme_id, const t8_element_t *elem, const int face,
   ...
   */
  inline void
  element_get_first_descendant_face (const t8_scheme_id scheme_id, const t8_element_t *elem, const int face,
   ...
   */
  inline void
  element_get_last_descendant_face (const t8_scheme_id scheme_id, const t8_element_t *elem, const int face,
   ...
   */
  inline bool
  element_is_root_boundary (const t8_scheme_id scheme_id, const t8_element_t *elem, const int face) const
  {
   ...
   */
  inline int
  element_get_face_neighbor_inside (const t8_scheme_id scheme_id, const t8_element_t *elem, t8_element_t *neigh,
   ...
   */
  inline t8_element_shape_t
  element_get_shape (const t8_scheme_id scheme_id, const t8_element_t *elem) const
  {
    return std::visit ([&] (auto &&scheme) { return scheme.element_get_shape (elem); }, eclass_schemes[scheme_id.get ()]);
  };
   ...
   */
  inline void
  element_set_linear_id (const t8_scheme_id scheme_id, t8_element_t *elem, const int level,
  ...
  element_get_linear_id (const t8_scheme_id scheme_id, const t8_element_t *elem, const int level) const
  {
   ...
   */
  inline void
  element_get_first_descendant (const t8_scheme_id scheme_id, const t8_element_t *elem, t8_element_t *desc,
   ...
   */
  inline void
  element_get_last_descendant (const t8_scheme_id scheme_id, const t8_element_t *elem, t8_element_t *desc,
                               const int level) const
  {
   ...
   */
  inline void
  element_construct_successor (const t8_scheme_id scheme_id, const t8_element_t *t, t8_element_t *s) const
  {
   ...
   */
  inline void
  element_get_vertex_reference_coords (const t8_scheme_id scheme_id, const t8_element_t *t, const int vertex,
                                       double coords[]) const
  {
   ...
   */
  inline void
  element_get_reference_coords (const t8_scheme_id scheme_id, const t8_element_t *elem, const double *ref_coords,
   ...
   */
  inline t8_gloidx_t
  element_count_leaves (const t8_scheme_id scheme_id, const t8_element_t *t, const int level) const
  {
   ...
   */
  inline t8_gloidx_t
  count_leaves_from_root (const t8_scheme_id scheme_id, const int level) const
  {
   ...
   */
  inline int
  element_is_valid (const t8_scheme_id scheme_id, const t8_element_t *elem) const
  {
    return std::visit ([&] (auto &&scheme) { return scheme.element_is_valid (elem); }, eclass_schemes[scheme_id.get ()]);
  };
 ...
 */
  inline void
  element_debug_print (const t8_scheme_id scheme_id, const t8_element_t *elem) const
  {
    return std::visit ([&] (auto &&scheme) { return scheme.element_debug_print (elem); }, eclass_schemes[scheme_id.get ()]);
  };
 ...
 */
  inline void
  element_to_string (const t8_scheme_id scheme_id, const t8_element_t *elem, char *debug_string,
   ...
   */
  inline void
  element_new (const t8_scheme_id scheme_id, const int length, t8_element_t **elem) const
  {
    return std::visit ([&] (auto &&scheme) { return scheme.element_new (length, elem); }, eclass_schemes[scheme_id.get ()]);
  };
   ...
   */
  inline void
  element_init (const t8_scheme_id scheme_id, const int length, t8_element_t *elem) const
  {
    return std::visit ([&] (auto &&scheme) { return scheme.element_init (length, elem); }, eclass_schemes[scheme_id.get ()]);
  };
   ...
   */
  inline void
  element_deinit (const t8_scheme_id scheme_id, const int length, t8_element_t *elem) const
  {
   ...
   */
  inline void
  element_destroy (const t8_scheme_id scheme_id, const int length, t8_element_t **elem) const
  {
   ...
   */
  inline void
  get_root (const t8_scheme_id scheme_id, t8_element_t *elem) const
  {
    return std::visit ([&] (auto &&scheme) { return scheme.get_root (elem); }, eclass_schemes[scheme_id.get ()]);
  };
  ...
  */
  inline void
  element_MPI_Pack (const t8_scheme_id scheme_id, t8_element_t **const elements, const unsigned int count,
  ...
  */
  inline void
  element_MPI_Pack_size (const t8_scheme_id scheme_id, const unsigned int count, sc_MPI_Comm comm, int *pack_size) const
  {
  ...
  */
  inline void
  element_MPI_Unpack (const t8_scheme_id scheme_id, void *recvbuf, const int buffer_size, int *position,
