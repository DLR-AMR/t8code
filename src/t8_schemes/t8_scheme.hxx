...
class t8_scheme {
  ...
  */
  ...
  inline void
  element_get_reference_coords (const t8_eclass_t tree_class, const t8_element_t *element, const TRefCoords &ref_coords,
                                TOutCoords &out_coords) const
  {
    return std::visit (
