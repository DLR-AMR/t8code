...
/** \file t8_scheme_algorithms_cxx.hxx
 * We provide basic implementations of tree algorithms
 */

#ifndef T8_SCHEME_ALGORITHMS_CXX
#define T8_SCHEME_ALGORITHMS_CXX

#include <t8_element_cxx.hxx>
#include <t8_element.h>
#include <sc_functions.h>

class t8_scheme_algorithms_c: public t8_eclass_scheme_c {
 public:
  /** Destructor for all default schemes */
  virtual ~t8_scheme_algorithms_c ()
  {
  }
  ...
  {
    t8_element_init (1, elem, 0); /* TODO: replace by root */
...
#endif /* T8_SCHEME_ALGORITHMS_CXX */
