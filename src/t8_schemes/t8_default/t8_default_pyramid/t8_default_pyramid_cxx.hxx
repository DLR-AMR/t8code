...
struct t8_default_scheme_pyramid_c: public t8_default_scheme_common_c
{
  ...
  */
   ...
   * \param [in] level    The level of the uniform refinement to consider.
   * \param [in] multilevel Shifts the linear id to make space for multiple levels. (Not implemented yet.)
   ...
   * \param [in] level      The level of the uniform refinement to consider.
   * \param [in] multilevel Consider ancestors as successors. (Not implemented yet.)
   */
  virtual void
  t8_element_successor (const t8_element_t *elem, t8_element_t *succ, const int level, const int multilevel) const;
