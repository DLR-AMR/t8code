 ...
 * CAREFUL: The local ID is different, if the element is in a tet
 * Iloc = A(type, cube_id)*/
 ...
 * CAREFUL: The pyramid types 6 and 7 are encoded as 0 and 1! Can not be used for tets
 ...
 * CAREFUL: The input type has to be the type of triangle
 ...
 * CAREFUL: The input type has to be the type of a tetrahedron
