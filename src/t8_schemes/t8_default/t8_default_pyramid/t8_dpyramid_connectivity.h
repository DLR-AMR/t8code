 ...
 * CAREFULL: The local ID is different, if the element is in a tet
 * Iloc = A(type, cube_id)*/
 ...
 * CAREFULL: The input type has to be the type of triangle
 ...
 * CAREFULL: The input type has to be the type of a tetrahedron
