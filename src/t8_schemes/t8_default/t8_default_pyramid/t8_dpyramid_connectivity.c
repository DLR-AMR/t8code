 ...
 */
const int           t8_dpyramid_parenttype_Iloc_to_type[4][10] = {
  {4, 2, 3, 4, 0, 4, 5, 4, -1, -1},
  {5, 0, 1, 5, 3, 4, 5, 5, -1, -1},
  {6, 3, 6, 0, 6, 0, 3, 6, 7, 6},
  {7, 0, 3, 6, 7, 3, 7, 0, 7, 7}
...
const int           t8_dpyramid_parenttype_Iloc_to_cid[4][10] = {
  {0, 4, 4, 4, 6, 6, 6, 7, -1, -1},
  {0, 4, 4, 4, 5, 5, 5, 7, -1, -1},
  {0, 1, 1, 2, 2, 3, 3, 3, 3, 7},
  {0, 4, 4, 4, 4, 5, 5, 6, 6, 7}
...
const int           t8_dpyramid_type_cid_to_Iloc[4][8] = {
  {0, 2, 2, 6, 3, 5, 5, 7},
  {0, 3, 3, 6, 3, 6, 6, 7},
  {0, 2, 4, 7, 3, -1, -1, 9},
  {0, -1, -1, 8, 4, 6, 8, 9}
 ...
 */
const int           t8_dpyramid_cid_type_to_parenttype[8][4] = {
  {0, 1, 2, 3},
  {0, 1, 1, 1},
  {2, 2, 2, 3},
  {1, 1, 2, 2},
...
const int           t8_dpyramid_type_Iloc_to_parenttype[4][10] = {
  {6, -1, 6, 7, 6, -1, -1, 6, -1, 6},
  {6, -1, 6, 7, 6, -1, -1, 6, -1, 6},
  {6, -1, 6, 7, 6, -1, -1, 6, -1, 6},
  {7, -1, -1, 7, 7, -1, 7, -1, 7, 7}
...
const int           t8_dpyramid_type_cid_to_parenttype[4][8] = {
  {6, 6, 6, 6, 7, -1, -1, 6},
  {6, 6, 6, 6, 7, -1, -1, 6},
  {6, 6, 6, 6, 7, -1, -1, 6},
  {7, -1, -1, 6, 7, 7, 7, 7}
...
const int           t8_dpyramid_parenttype_iloc_pyra_w_lower_id[4][10] = {
  {0, 1, 1, 2, 2, 3, 3, 3, 4, 5},
  {0, 1, 1, 2, 2, 3, 3, 3, 4, 5},
  {0, 1, 1, 2, 2, 3, 3, 3, 4, 5},
  {0, 1, 1, 1, 2, 3, 3, 4, 4, 5}
...
const int           t8_dpyramid_type_face_to_nface[4][5] = {
  {2, 3, 2, 3, 4},
  {1, 0, 1, 0, 4},
  {1, 0, 1, 0, 4},
  {1, 0, 1, 0, 4}
...
*/
const int           t8_dpyramid_type_face_to_children_at_face[4][5][4] = {
  {{0, 3, 4, 9},
   {2, 5, 7, 9},
   {0, 1, 2, 9},
   {4, 6, 7, 9},
...
const int           t8_dpyramid_type_face_to_child_face[4][5][4] = {
  {{0, 1, 0, 0},
   {1, 0, 1, 1},
   {2, 1, 2, 2},
   {3, 0, 3, 3},
