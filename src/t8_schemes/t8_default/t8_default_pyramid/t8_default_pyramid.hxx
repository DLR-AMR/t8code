 ...
 * implementations in \file t8_dpyramid_bits.hxx
 */
...
class t8_default_scheme_pyramid: public t8_default_scheme_common<T8_ECLASS_PYRAMID, t8_default_scheme_pyramid> {
 public:
  ...
  using helpers = t8_scheme_helpers<T8_ECLASS_PYRAMID, t8_default_scheme_pyramid>;
  ...
  */
  ...
  element_get_reference_coords (const t8_element_t *elem, const TRefCoords &ref_coords, TOutCoords &out_coords) noexcept
  {
    ...
    if (t8_dpyramid_shape (pyra) == T8_ECLASS_PYRAMID) {
      ...
      t8_default_scheme_tet::element_get_reference_coords ((const t8_element_t *) &(pyra->pyramid), ref_coords,
                                                           out_coords);
    }
  }
