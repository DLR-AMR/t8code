...
class t8_default_scheme_vertex: public t8_default_scheme_common<T8_ECLASS_VERTEX, t8_default_scheme_vertex> {
  ...
  */
  ...
  {
    constexpr std::size_t coord_type_dim = std::tuple_size_v<TOutCoords>;
    static_assert (coord_type_dim >= 1,
  ...
  element_get_reference_coords (const t8_element_t *elem, const TRefCoords &ref_coords, TOutCoords &out_coords) noexcept
  {
    ...
    constexpr std::size_t coord_type_dim = std::tuple_size_v<coord_type>;
    static_assert (coord_type_dim >= 1,
                   "Input dimension for element_get_reference_coords for element class vertex is too small.");
