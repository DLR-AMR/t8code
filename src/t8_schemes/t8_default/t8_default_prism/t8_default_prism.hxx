...
class t8_default_scheme_prism: public t8_default_scheme_common<t8_default_scheme_prism> {
  ...
  */
   ...
   */
  void
  element_get_sibling ([[maybe_unused]] const t8_element_t *elem, [[maybe_unused]] int sibid, [[maybe_unused]] t8_element_t *sibling) const
  {
   ...
   */
  void
  element_transform_face ([[maybe_unused]] const t8_element_t *elem1, [[maybe_unused]] t8_element_t *elem2, [[maybe_unused]] int orientation, [[maybe_unused]] int sign,
