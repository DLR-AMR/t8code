...
int
t8_default_scheme_hex::element_get_num_face_children ([[maybe_unused]] const t8_element_t *elem, [[maybe_unused]] const int face) const
{
  T8_ASSERT (element_is_valid (elem));
  return 4;
}
...
int
t8_default_scheme_hex::element_get_face_corner ([[maybe_unused]] const t8_element_t *element, const int face, const int corner) const
{
...
void
t8_default_scheme_hex::element_get_children (const t8_element_t *elem, [[maybe_unused]] int length, t8_element_t *c[]) const
{
  T8_ASSERT (element_is_valid (elem));
...
t8_element_shape_t
t8_default_scheme_hex::element_get_face_shape ([[maybe_unused]] const t8_element_t *elem, [[maybe_unused]] const int face) const
{
  T8_ASSERT (element_is_valid (elem));
