...
#if 0
int
t8_dtet_element_pack (const t8_dtet_t *elements, int count, void *send_buffer, int buffer_size,
...
int
t8_dtet_element_unpack (void *recvbuf, int buffer_size, int *position, t8_dtet_t *elements,
