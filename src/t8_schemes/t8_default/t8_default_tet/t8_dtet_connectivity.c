...
const int t8_dtet_type_of_child_morton[6][8]
  = { { 0, 0, 4, 5, 0, 1, 2, 0 }, { 1, 1, 2, 3, 0, 1, 5, 1 }, { 2, 0, 1, 2, 2, 3, 4, 2 },
      { 3, 3, 4, 5, 1, 2, 3, 3 }, { 4, 2, 3, 4, 0, 4, 5, 4 }, { 5, 0, 1, 5, 3, 4, 5, 5 } };
...
const int t8_dtet_type_cid_to_beyid[6][8]
  = { { 0, 1, 4, 7, 5, 2, 6, 3 }, { 0, 1, 5, 2, 4, 7, 6, 3 }, { 0, 5, 1, 2, 4, 6, 7, 3 },
      { 0, 4, 1, 7, 5, 6, 2, 3 }, { 0, 4, 5, 6, 1, 7, 2, 3 }, { 0, 5, 4, 6, 1, 2, 7, 3 } };
...
const int t8_dtet_parenttype_beyid_to_Iloc[6][8]
  = { { 0, 1, 4, 7, 2, 3, 6, 5 }, { 0, 1, 5, 7, 2, 3, 6, 4 }, { 0, 3, 4, 7, 1, 2, 6, 5 },
      { 0, 1, 6, 7, 2, 3, 4, 5 }, { 0, 3, 5, 7, 1, 2, 4, 6 }, { 0, 3, 6, 7, 2, 1, 4, 5 } };

const int t8_dtet_type_cid_to_Iloc[6][8]
  = { { 0, 1, 1, 4, 1, 4, 4, 7 }, { 0, 1, 2, 5, 2, 5, 4, 7 }, { 0, 2, 3, 4, 1, 6, 5, 7 },
      { 0, 3, 1, 5, 2, 4, 6, 7 }, { 0, 2, 2, 6, 3, 5, 5, 7 }, { 0, 3, 3, 6, 3, 6, 6, 7 } };
...
const int t8_dtet_parenttype_Iloc_to_cid[6][8]
  = { { 0, 1, 1, 1, 5, 5, 5, 7 }, { 0, 1, 1, 1, 3, 3, 3, 7 }, { 0, 2, 2, 2, 3, 3, 3, 7 },
      { 0, 2, 2, 2, 6, 6, 6, 7 }, { 0, 4, 4, 4, 6, 6, 6, 7 }, { 0, 4, 4, 4, 5, 5, 5, 7 } };
...
const int t8_dtet_parent_type_type_to_face[6][6]
  = { { -1, 0, 2, -1, 1, 3 }, { 0, -1, 3, 1, -1, 2 }, { 1, 3, -1, 0, 2, -1 },
      { -1, 2, 0, -1, 3, 1 }, { 2, -1, 1, 3, -1, 0 }, { 3, 1, -1, 2, 0, -1 } };
