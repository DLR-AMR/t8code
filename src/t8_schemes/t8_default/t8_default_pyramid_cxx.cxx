...
int
t8_default_scheme_pyramid_c::t8_element_child_id (const t8_element_t * elem) const
{
  return t8_dpyramid_child_id ((const t8_dpyramid_t *) elem);
}
...
int
t8_default_scheme_pyramid_c::t8_element_is_family (const t8_element_t ** fam) const
{
