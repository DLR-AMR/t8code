...
void
t8_default_scheme_line_c::t8_element_vertex_coords_of_subelement (const
                                                                  t8_element_t
                                                                  * t,
                                                                  int vertex,
                                                                  int
...
int
t8_default_scheme_line_c::t8_element_get_number_of_subelements (int
                                                                subelement_type)
{
  SC_ABORT ("This function is not implemented yet.\n");
}
...
t8_element_shape_t
  t8_default_scheme_line_c::t8_element_get_shape (const t8_element_t * elem)
{
  SC_ABORT ("This function is not implemented yet.\n");
}
