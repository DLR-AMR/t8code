...
class t8_default_scheme_line: public t8_default_scheme_common<t8_default_scheme_line> {
  ...
  */
   ...
   */
  constexpr int
  element_get_face_corner ([[maybe_unused]] const t8_element_t *element, const int face, [[maybe_unused]] const int corner) const
  {
    T8_ASSERT (corner == 0);
    return face;
  }
   ...
   */
  constexpr int
  element_get_corner_face ([[maybe_unused]] const t8_element_t *element, const int corner, [[maybe_unused]] const int face) const
  {
    T8_ASSERT (face == 0);
    return corner;
  }
