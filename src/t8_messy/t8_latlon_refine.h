 ...
 */
int         t8_latlon_adapt_callback (t8_forest_t forest,
 ...
 *                           level of adaptation.
 * \param [out]   level      If not NULL, the maximum refinement level 
 *                           (= level of the \a x_lenght times \a y_length grid) is stored here.
 */
