...
struct t8_geometry_occ: public t8_geometry_with_vertices
{
 ...
 private:
   ...
   */
  void
  t8_geom_evaluate_occ_tri (t8_cmesh_t cmesh, t8_gloidx_t gtreeid, const double *ref_coords, const size_t num_coords,
                            double *out_coords) const;
   ...
   */
  void
  t8_geom_evaluate_occ_prism (t8_cmesh_t cmesh, t8_gloidx_t gtreeid, const double *ref_coords, const size_t num_coords,
                              double *out_coords) const;
