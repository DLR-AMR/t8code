...
template <unsigned int DIM, size_t N>
inline void
extract_cartesian_vertices (const std::array<std::array<double, 3>, N> &physical_vertices,
                            std::array<double, DIM> &vertices_min, std::array<double, DIM> &vertices_max) noexcept
{
