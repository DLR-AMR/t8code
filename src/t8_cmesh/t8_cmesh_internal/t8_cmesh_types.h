...
#define T8_CMESH_BOUNDARY_CONDITION_ATTRIBUTE_KEY   3 /**< Used to store the boundary condition of each tree's face. */
...
*/
  ...
  t8_cmesh_boundary_condition_handler_c
    *boundary_condition_handler; /**< Handles all boundary conditions that are used by trees in this cmesh. */
