...
/** Used to store the geometry dimension and tag of the nodes of a tree. */
#define T8_CMESH_NODE_GEOMETRY_ATTRIBUTE_KEY 3
/** Used to store node parameters of a tree. Used in combination with T8_CMESH_NODE_GEOMETRY_ATTRIBUTE_KEY */
#define T8_CMESH_NODE_PARAMETERS_ATTRIBUTE_KEY 4
