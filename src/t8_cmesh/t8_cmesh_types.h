...
#define T8_CMESH_PATCH_STRETCH_FACTORS_KEY \
  T8_CMESH_OCC_FACE_PARAMETERS_ATTRIBUTE_KEY \
  +T8_ECLASS_MAX_FACES /* Used to store the patch stretch factors of a tree */
#define T8_CMESH_NEXT_POSSIBLE_KEY \
  T8_CMESH_PATCH_STRETCH_FACTORS_KEY + 1 /* The next free value for a t8code attribute key */
