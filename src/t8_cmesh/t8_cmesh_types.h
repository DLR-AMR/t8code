...
*/
  ...
  int set_partition_multilevel; /**< Positive if the cmesh should be partitioned from an already existing cmesh
                                         with an assumed multilevel uniform mesh underneath. */
