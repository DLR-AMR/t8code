...
{
  SC_ABORT ("The function t8_cmesh_load_and_distribute is currently not supported, because it's functionality is not up-to-date!\n");
  t8_cmesh_t cmesh;

  // Pseudo-usage of function arguments to suppress unused-argument compiler warning.
  (void) fileprefix; (void) num_files; (void) comm; (void) mode; (void) procs_per_node;
