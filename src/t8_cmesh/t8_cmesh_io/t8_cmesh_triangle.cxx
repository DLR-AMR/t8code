...
{
  SC_ABORT ("The function t8_cmesh_from_triangle_file is currently not supported, because it's functionality is not up-to-date!\n");

  // Pseudo-usage of function arguments to suppress unused-argument compiler warning.
  (void) fileprefix; (void) partition; (void) comm; (void) do_dup;
...
{
  SC_ABORT ("The function t8_cmesh_from_tetgen_file_time is currently not supported, because it's functionality is not up-to-date!\n");

  // Pseudo-usage of function arguments to suppress unused-argument compiler warning.
  (void) fileprefix; (void) partition; (void) comm; (void) do_dup; (void) fi; (void) snapshot; (void) stats; (void) statentry;
...
{
  SC_ABORT ("The function t8_cmesh_from_tetgen_file is currently not supported, because it's functionality is not up-to-date!\n");
