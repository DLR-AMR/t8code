 ...
 * \param [in,out]  cmesh      An initialized, but not committed cmesh, as created by \ref t8_cmesh_init.
 *                             The dimension of the cmesh must already be set via \ref t8_cmesh_set_dimension.
 *                             Committed in place.
 * \param [in]      comm       mpi communicator to be used with the new cmesh.
 */
void
 ...
 */
void
t8_cmesh_new_brick_2d (t8_cmesh_t cmesh, t8_gloidx_t num_x, t8_gloidx_t num_y, int x_periodic, int y_periodic,
                       sc_MPI_Comm comm);
 ...
 */
void
t8_cmesh_new_brick_3d (t8_cmesh_t cmesh, t8_gloidx_t num_x, t8_gloidx_t num_y, t8_gloidx_t num_z, int x_periodic,
