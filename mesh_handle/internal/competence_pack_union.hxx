 ...
 * A new element_competence_pack is produced.
...
/** Compute the unique union of the competences of two \ref element_competence_pack 's.
 * This produces a new \ref element_competence_pack containing all competences with duplicates removed.
...
/** Recursive case: Compute the unique union of the competences of more than one  \ref element_competence_pack 's.
 * Specialization for the case when there are still at least two competence packs left to process.
 * Uses \ref union_two_element_competence_packs recursively for pairwise combination.
 ...
 *         Each competence pack is expected to be of type \ref element_competence_pack.
 */
template <typename TPack, typename... TPacks>
struct union_competence_packs
{
  /** This is the type of a new \ref element_competence_pack containing all competences of the competence packs 
