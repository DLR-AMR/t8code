...
class class_schemes_descendant: public testing::TestWithParam<t8_eclass_t> {
 protected:
  ...
  SetUp () override
  {
    ...
    scheme = t8_scheme_new_transition_hex_cxx ();
...
INSTANTIATE_TEST_SUITE_P (t8_gtest_descendant, class_schemes_descendant, testing::Values (T8_ECLASS_HEX), print_eclass);
