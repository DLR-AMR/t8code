...
/*
  This test creates a hyperquad to check if the t8_cmes_boundary_node_list works properly.
  It checks for the right amount of boundary nodes, and then the correct global ID
