...
/* *INDENT-OFF* */
INSTANTIATE_TEST_SUITE_P (t8_gtest_half_neighbors, forest_half_neighbors,testing::Combine(testing::Range(T8_ECLASS_VERTEX, T8_ECLASS_COUNT),testing::Range(0,3)));
/* *INDENT-ON* */
