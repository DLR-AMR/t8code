...
using myTypes = ::testing::Types<
  std::integral_constant<t8_eclass_t, T8_ECLASS_VERTEX>, std::integral_constant<t8_eclass_t, T8_ECLASS_LINE>,
  std::integral_constant<t8_eclass_t, T8_ECLASS_QUAD>, std::integral_constant<t8_eclass_t, T8_ECLASS_TRIANGLE>,
  std::integral_constant<t8_eclass_t, T8_ECLASS_HEX>, std::integral_constant<t8_eclass_t, T8_ECLASS_TET>,
  std::integral_constant<t8_eclass_t, T8_ECLASS_PRISM>, std::integral_constant<t8_eclass_t, T8_ECLASS_PYRAMID> >;
